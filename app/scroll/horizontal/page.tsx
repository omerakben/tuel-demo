  ...
  return (
    <div className="bg-black">
      ...
      <div ref={containerRef} className="relative h-screen overflow-hidden">
        <div ref={sliderRef} className="flex h-full absolute top-0 left-0">
          {slides.map((slide, index) => (
            ...
            >
              {/* Background Gradient */}
              <div
                className={`absolute inset-0 bg-gradient-to-br ${slide.color} opacity-30`}
              />
              ...
              <div className="relative z-10 text-center px-6">
                ...
                <p className="text-xl text-gray-300 max-w-md mx-auto">
                  Scroll horizontally to explore amazing content with smooth
                  parallax effects.
                </p>
              </div>
